...
%%
% Adding case with very low training set
...
%%
[nn_t_case1, error, it_bfgs] = batch_cg_bfgs_training_prototype(input_sets_case1,  ...
                                                                targets_case1,     ...
                                                                nn_case1,          ...
                                                                train_par);

%%
[nn_t_case2, error, it_bfgs] = batch_cg_bfgs_training_prototype(input_sets_case2,  ...
                                                                targets_case2,     ...
                                                                nn_case2,          ...
                                                                train_par);
